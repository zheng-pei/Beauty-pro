...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (this.opens == 'right1') {
            //swap calendar positions
            var left = this.container.find('.calendar.left');
            var right = this.container.find('.calendar.right1');
            left.removeClass('left').addClass('right1');
            right.removeClass('right1').addClass('left');
        }
    ...
    DateRangePicker.prototype = {
        ...
        updateTime: function (e) {
            ...
            if (!isLeft)
                cal = this.container.find('.calendar.right1');
